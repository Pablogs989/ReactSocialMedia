...
const SharePost = () => {
  ...
  return (
    <ul class="wrapper">
      <li class="icon facebook" onClick={handleClickFacebook}>
      ...
      <li class="icon twitter" onClick={handleClickTwitter}>
      ...
      <li class="icon instagram" onClick={handleClickInstagram}>
